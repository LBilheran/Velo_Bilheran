...
Object::Object(std::vector<glm::vec3> vertices, std::vector<glm::vec2> uvs, std::vector<glm::vec3> normalsb, std::string texturePath):m_vb(0), m_uvsb(0), m_texture(0), position(0,0,0), rotationAngles(0,0,0)
{

     m_vb = new VertexBuffer(vertices);
     m_uvsb = new UVBuffer(uvs);
     m_normalsb = new VertexBuffer(normalsb);

     m_texture = new Texture(texturePath);

}

Object::Object(const char *path, std::string texturePath):m_vb(0), m_uvsb(0), m_texture(0), position(0.0f, 0.0f, 0.0f), rotationAngles(0.0,0.0f,0.0f)
{
    ...
    m_texture = new Texture(texturePath);
    m_normalsb = new VertexBuffer(out_normals);
}
